...
import type { ICall, IContact } from "@src/utils/types";
  ...
  <div class="w-full h-full pt-6 flex flex-col items-center">
    ...
    <div class="mb-7">
      <div class="relative mb-5">
        <CallAvatar v-for="(member, index) in members" :member="member" :index="index" :members-length="members.length"
          :large="true" />
      </div>

      <p class="heading-2 text-black/70 dark:text-white/70 mb-4 outline-none" tabindex="0">
    ...
    <div class="mb-9 flex">
      ...
      <div class="mr-5 flex flex-col justify-center items-center">
        <IconButton class="ic-btn-contained-gray p-3 mb-3">
          <SpeakerXMarkIcon class="w-4.25 h-4.25 text-black/60 dark:text-white/70" />
        </IconButton>
      ...
      <div class="flex flex-col justify-center items-center">
        <IconButton class="ic-btn-contained-gray p-3 mb-3">
          <ChatBubbleBottomCenterTextIcon class="w-4.25 h-4.25 text-black/60 dark:text-white/70" />
        </IconButton>
    ...
    <!--call actions-->
    <div class="relative w-full h-12.5 rounded-b-xl flex justify-center bg-gray-50 dark:bg-gray-700">
