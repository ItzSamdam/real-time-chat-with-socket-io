...
import type { IConversation } from "@src/utils/types";
  ...
  <div>
    ...
    <div ref="contactContainer">
      <ScrollBox class="max-h-58 overflow-y-scroll">
        <ContactItem variant="card" @contact-selected="
          (contact) =>
            $emit('active-page-change', {
              tabName: 'conversation-info',
          ...
          ">
            <div>
              ...
              <Dropdown :close-dropdown="closeDropdowns" :handle-click-outside="handleClickOutside"
                ...
                <button class="dropdown-link dropdown-link-primary" aria-label="give admin permissions" role="menuitem">
                  Promote to admin
                </button>
                <button class="dropdown-link dropdown-link-primary" aria-label="remove admin permissions"
                  role="menuitem">
                  Demote to member
                </button>
                <button class="dropdown-link dropdown-link-danger" aria-label="remove contacts" role="menuitem">
                  Remove contact
                </button>
              </Dropdown>
            </div>
