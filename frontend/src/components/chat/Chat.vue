...
import ChatBottom from "@src/components/chat/chat-bottom/ChatBottom.vue";
import ChatMiddle from "@src/components/chat/chat-middle/ChatMiddle.vue";
import ChatTop from "@src/components/chat/chat-top/ChatTop.vue";
