...
import AttachmentsModal from "@src/components/modals/attachments-modal/AttachmentsModal.vue";
import Button from "@src/components/ui/inputs/Button.vue";
import IconButton from "@src/components/ui/inputs/IconButton.vue";
import ScaleTransition from "@src/components/ui/transitions/ScaleTransition.vue";
import ReplyMessage from "@src/components/chat/chat-bottom/ReplyMessage.vue";
import EmojiPicker from "@src/components/ui/inputs/emoji-picker/EmojiPicker.vue";
