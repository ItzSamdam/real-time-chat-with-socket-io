...
import type { IConversation, IMessage } from "@src/types/messaging";
...
import MediaItem from "@src/components/modals/conversation-info-modal/shared-media-tab/MediaItem.vue";
