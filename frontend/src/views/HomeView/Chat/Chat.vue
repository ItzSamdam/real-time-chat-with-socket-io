...
import ChatBottom from "@src/views/HomeView/Chat/ChatBottom/ChatBottom.vue";
import ChatMiddle from "@src/views/HomeView/Chat/ChatMiddle/ChatMiddle.vue";
import ChatTop from "@src/views/HomeView/Chat/ChatTop/ChatTop.vue";
