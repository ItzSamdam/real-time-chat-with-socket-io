...
import type { IConversation, IMessage } from "@src/utils/types";
...
<template>
  ...
  <Dropdown :close-dropdown="handleCloseContextMenu" :handle-click-outside="handleCloseContextMenu" :show="show"
    ...
    <button v-else class="dropdown-link dropdown-link-primary" role="menuitem" aria-label="select this message" @click="
      () => {
        handleCloseContextMenu();
